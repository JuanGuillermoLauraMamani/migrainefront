...
predecir= async (e)=>{
  ...
  renderpacientes = async () => {
    ...
    await axios
      .post(
        `${process.env.API_URL}/api/pacient/pacientes`,
  ...
  abrilmodalsintomas = async (idpac) => {
    ...
    await axios
      .get(
       `${process.env.API_URL}/api/pacient/paciente/` +idpac,
        {
          headers: {
  ...
  updatediagnosticopac = async () => {
    ...
    await axios
      .put(
        `${process.env.API_URL}/api/pacient/pacientes/` + iduser,
        JSON.stringify({
  ...
  editarpaciente= async () => {
    ...
    await axios
      .put(
        `${process.env.API_URL}/api/pacient/paciente/` + iduser,
        JSON.stringify({
          _id:iduser,
          ci: this.state.ci,
  ...
  borrarpaciente = async (idpac) => {
    ...
    console.log(token)
      ...
      await axios.delete(`${process.env.API_URL}/api/pacient/paciente/${idpac}`, 
        {headers: {
          "Content-type": "application/json",
            "x-access-token": token,
        }
