...
predecir= async (e)=>{
  ...
  renderpacientes = async () => {
    ...
    await axios
      .post(
        `http://localhost:4000/api/pacient/pacientes`,
  ...
  abrilmodalsintomas = async (idpac) => {
    ...
    await axios
      .get(
        "http://localhost:4000/api/pacient/paciente/" +idpac,
        {
          headers: {
  ...
  updatediagnosticopac = async () => {
    ...
    await axios
      .put(
        "http://localhost:4000/api/pacient/pacientes/" + iduser,
        JSON.stringify({
  ...
  editarpaciente= async () => {
    ...
    await axios
      .put(
        "http://localhost:4000/api/pacient/paciente/" + iduser,
        JSON.stringify({
          _id:iduser,
          ci: this.state.ci,
  ...
  borrarpaciente = async (idpac) => {
    ...
    console.log(token)
      ...
      await axios.delete(`http://localhost:4000/api/pacient/paciente/${idpac}`, 
        {headers: {
          "Content-type": "application/json",
            "x-access-token": token,
        }
